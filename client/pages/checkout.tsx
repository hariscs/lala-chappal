...
export default function Checkout() {
  ...
  return (
    <div className="py-8 px-4 lg:py-16 lg:px-16 flex">
      <div className="w-1/2 pr-4">
        ...
        <form onSubmit={(e) => handlePurchaseForm(e)}>
          ...
          <div className="flex space-x-4 mt-8 justify-end">
            <button
              disabled={loading}
              className="bg-transparent capitalize rounded-2xl text-primary border border-primary lg:py-4 lg:px-12 text-base"
              onClick={() => router.back()}
              type="button"
            >
              Go back
      ...
      <div className="w-[1px] h-screen bg-neutral-200 mx-8"></div>
