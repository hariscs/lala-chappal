...
export default function Checkout() {
  ...
  return (
    <div>
      <form
        onSubmit={(e) => handlePurchaseForm(e)}
        className='py-8 px-4 lg:py-16 lg:px-16 flex flex-col xl:flex-row overflow-hidden items-center xl:items-start'
      >
        <div className='pr-4 w-full'>
          ...
          <div className='lg:flex hidden space-x-4 mt-8 justify-between'>
            <button
              disabled={loading}
            ...
            <button
              disabled={loading}
              className='bg-primary disabled:bg-primary/30 capitalize rounded-2xl text-white text-base lg:text-2xl py-2 px-6 lg:py-4 lg:px-12'
              type='submit'
            >
              Confirm Purchase
            </button>
        ...
        <div className='pl-4 w-full'>
          ...
          <div className='border-gray-300 flex items-start flex-col w-full space-y-3'>
            <p className={itemFlex}>
              <span>Name</span>
              <span>
                <b>Custom-{query?.design as string}</b>
              </span>
            </p>
            <p className={itemFlex}>
              <span>Color</span>
        ...
        <div className='flex lg:hidden items-center w-full mt-8 justify-between'>
          <button
            disabled={loading}
            className='bg-transparent capitalize rounded-2xl text-primary border border-primary py-2 px-6 lg:py-4 lg:px-12 text-base'
            onClick={() => router.back()}
